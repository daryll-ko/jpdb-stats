...
# ╔═╡ 68f860e1-9ed5-472a-8f07-fe58bf4b4158
@bind date_offset Slider(-12:12, show_value=true)

# ╔═╡ 62ec0354-5560-4470-b4c2-640e241dee7e
function localize(date)
    return date + Hour(date_offset)
end
...
my_kanji_counter = get_kanji_counter(cards)

# ╔═╡ 3510cbf5-eb56-4ff3-b38b-e5a5f31180df
my_kanji_list = collect(keys(my_kanji_counter))

# ╔═╡ 629636de-3336-44b8-b298-698eeee3accb
my_kanji_set = Set(my_kanji_list)

# ╔═╡ c4556630-7b1f-4fac-a3b0-5d153a9739b1
length.([my_kanji_counter, my_kanji_list, my_kanji_set])
...
jouyou_kanji_set = Set(jouyou_kanji_list)

# ╔═╡ 8d86b08e-3fb9-4dbb-8609-21f035055caa
length.([jouyou_kanji_string, jouyou_kanji_list, jouyou_kanji_set])

# ╔═╡ fe123bec-051a-4189-9116-16c89ce583a9
jouyou_kanji_known = my_kanji_set ∩ jouyou_kanji_set

# ╔═╡ f93b75a0-26e8-4b89-9c72-358d0412d7ca
length(jouyou_kanji_known)

# ╔═╡ 4fa3d354-bec3-47bf-a102-602482d528c8
length(jouyou_kanji_known) / length(jouyou_kanji_set)

# ╔═╡ a7db8b84-c482-4772-b68e-f5abc74a3388
jouyou_kanji_not_known = collect(setdiff(jouyou_kanji_set, my_kanji_set))

# ╔═╡ de881f61-370c-4eee-8838-a94671c232ff
length(jouyou_kanji_not_known)

# ╔═╡ 1e24c261-f1bc-464e-b9c0-7b8cbf2563fa
non_jouyou_kanji_known = collect(setdiff(my_kanji_set, jouyou_kanji_set))

# ╔═╡ 2ef28e10-2e5e-484b-9de1-a6e5fc1a5f48
length(non_jouyou_kanji_known)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "d08fbea4d3ff3125defa7cfc01bf84a3fdb45852"
